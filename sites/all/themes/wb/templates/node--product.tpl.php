	...
	<div class="wb-product-page">
		<div class="wb-product-tbl">
            	...
            	<?php if(!is_null($product['mainImage'])): ?>
                    <div class="wb-product-image">
                        ...
                        <?php if($product['isLeader']): ?>
                        	<span class="wb-product-page-leader"><?= t('Лидер продаж') ?></span>
                        <?php endif; ?>
                        <?php if($product['isSellOut']): ?>
                        	<span class="wb-product-page-sellout"><?= t('Распродажа') ?></span>
                        <?php endif; ?>
            ...
            <div class="wb-product-tbl-right">
            	<?php if(!is_null($product['title'])): ?>
                    <div class="wb-product-title">
                        <h2><?= $product['title'] ?></h2>
                    </div>
                <?php endif; ?>
                ...
                <div class="wb-product-card">
                    <div class="product-page-product-count">
                        ...
                        <div class="product-page-product-count-value">
                            <input type="number" value="1" min = "1" max = "1000" id="card-products-count" placeholder = "Кол-во" />
                        </div>
